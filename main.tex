...
\chapter{寮生の声}
  ...
  \input{2025shinki/shinya_haikai/main}
  \newpage
  \subfile{2025shinki/nuigurumi_zadankai/nuigurumi}
  \newpage
  
  \section{ボドゲの定石を作る 〜WINGSPANを題材にして〜}
  \input{2025shinki/wing_span/wingspan}

  
  \newpage
  \section{出張版 C12 談話室 on web 「とある日のこと」}
  
  \input{2025shinki/c12_danwa_one_day/main_text-toaruhinokoto}

  \newpage
  
  \input{2025shinki/bear_lexicon_news}

  \newpage
  \input{2025shinki/konpa_furumai/konpa_furumai.tex}

  \newpage
  \input{2025shinki/yamano_susume/yamano_susume}

  \newpage
  \input{2025shinki/joshi_ryosei/joshi_ryosei.tex}
